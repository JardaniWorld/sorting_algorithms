...
/**
* swap - This function swaps 2 nodes in a doubly-linked list
...
/**
* tail_traverse- This function sorts from the tail back
*
* @head: head of list
...
/**
* cocktail_sort_list - This function sorts linked list
